...
public class SetUpDatabase0 {
    private final String username;
    private final String pwd;
    private String conn;

    public SetUpDatabase0(String conn, String username, String pwd) {
        this.conn = conn;
    ...
    private void dropTableEmpleados(Statement stmt) throws SQLException {
        try {
            stmt.executeUpdate("DROP TABLE Empleados");
        } catch (Exception e) {
          if (!(e instanceof SQLException && e.getMessage().contains("does not exist"))) {
              throw e;
          }
        }
    }
